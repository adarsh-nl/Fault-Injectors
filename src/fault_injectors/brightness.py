"""BrightnessInjector - EXACT MultiCorrupt brightness (arXiv:2402.11677).

Overexposure by adding s=0.5/0.6/0.7 to the V channel in HSV space. Camera only.
The corruption function is MultiCorrupt's converter/img.py 'brightness', called verbatim
(see _mc_image.py). The wrapper only seeds numpy for reproducibility and returns
uint8; it does not alter the algorithm.
"""
from __future__ import annotations
import numpy as np
from ._mc_image import brightness as _mc_fn
