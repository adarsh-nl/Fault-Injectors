"""FogInjector - EXACT MultiCorrupt fog (arXiv:2402.11677).

Plasma-fractal haze + depth-cued transmission veil (visibility 300/150/50 m). Camera only. (MultiCorrupt's 'Fog'; == what you called smoke.)
The corruption function is MultiCorrupt's converter/img.py 'fog', called verbatim
(see _mc_image.py). The wrapper only seeds numpy for reproducibility and returns
uint8; it does not alter the algorithm.
"""
from __future__ import annotations
import numpy as np
from ._mc_image import fog as _mc_fn
