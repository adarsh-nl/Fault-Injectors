# --- NumPy 2.0 compatibility shim (added; MultiCorrupt code below is verbatim) ---
# np.float_ was removed in NumPy 2.0; it was an exact alias of np.float64.
import numpy as _np_compat
if not hasattr(_np_compat, "float_"): _np_compat.float_ = _np_compat.float64
# --- end shim ---
